...
class Keyboard():
    ...
    menu_keyboard = ReplyKeyboardMarkup([['1', '2', '3', '4'], ['5', '6']], resize_keyboard=True)

    l2_two = ReplyKeyboardMarkup([['1', '2'], ['Menu']], resize_keyboard=True)

    l2_three = ReplyKeyboardMarkup([['1', '2', '3'], ['Menu']], resize_keyboard=True)

    l2_five = ReplyKeyboardMarkup([['1', '2', '3', '4'], ['5', 'Menu']], resize_keyboard=True)

    l2_four = ReplyKeyboardMarkup([['1', '2', '3', '4'], ['Menu']], resize_keyboard=True)

    l2_six = ReplyKeyboardMarkup([['1', '2', '3', '4'], ['5', '6', 'Menu']], resize_keyboard=True)

    l2_seven = ReplyKeyboardMarkup([['1', '2', '3', '4'], ['5', '6', '7', 'Menu']], resize_keyboard=True)
