...
def m_4(bot, update):
    update.message.reply_text(t.t2_4, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_1(bot, update):
    update.message.reply_text(t.t2_4_1, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_2(bot, update):
    update.message.reply_text(t.t2_4_2, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_3(bot, update):
    update.message.reply_text(t.t2_4_3, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_4(bot, update):
    update.message.reply_text(t.t2_4_4, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_5(bot, update):
    update.message.reply_text(t.t2_4_5, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_6(bot, update):
    update.message.reply_text(t.t2_4_6, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4

def m_4_7(bot, update):
    update.message.reply_text(t.t2_4_7, reply_markup=k.l3_seven, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_4
