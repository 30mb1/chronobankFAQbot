...
def m_2(bot, update):
    update.message.reply_text(t.t2_2, reply_markup=k.l3_four, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_2

def m_2_1(bot, update):
    update.message.reply_text(t.t2_2_1, reply_markup=k.l3_four, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_2

def m_2_2(bot, update):
    update.message.reply_text(t.t2_2_2, reply_markup=k.l3_four, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_2

def m_2_3(bot, update):
    update.message.reply_text(t.t2_2_3, reply_markup=k.l3_four, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_2

def m_2_4(bot, update):
    update.message.reply_text(t.t2_2_4, reply_markup=k.l3_four, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_2

def m_3(bot, update):
    update.message.reply_text(t.t2_3, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3

def m_3_1(bot, update):
    update.message.reply_text(t.t2_3_1, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3

def m_3_2(bot, update):
    update.message.reply_text(t.t2_3_2, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3

def m_3_3(bot, update):
    update.message.reply_text(t.t2_3_3, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3

def m_3_4(bot, update):
    update.message.reply_text(t.t2_3_4, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3

def m_3_5(bot, update):
    update.message.reply_text(t.t2_3_5, reply_markup=k.l3_five, parse_mode=ParseMode.MARKDOWN)
    return BRANCH2_3
